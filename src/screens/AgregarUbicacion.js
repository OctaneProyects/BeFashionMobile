...
export function AgregarUbicacion({ navigation }) {
    ...
    const GetClientes = async () => {
        ...
        try {
            await axios
                .get(`${BASE_URL}clientes/GetClientes`, {})
                .then((res) => {
                    const result = res.data;
                    let jsonClientes = JSON.parse(result);

                    setClientes(jsonClientes.map(cli => {
        ...
        try {
            await axios
                ...
                .then((res) => {
                    ...
                    setSucursales(jsonSucursal.map(suc => {
    ...
    const insertTienda = async () => {
        if (cliente == null || sucursal == null || nombreTienda == '') {
            Alert.alert('Verifique datos', 'Verifique que todos los campos contengan datos validos', [
                { text: 'Aceptar' },
            ]);
            return;
        }
